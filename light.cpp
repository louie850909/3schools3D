...
XMFLOAT3 RiseToNoon = XMFLOAT3((LIGHT_NOON_POS_X - LIGHT_SUNRISE_POS_X) / SUN_MOVING_TIME,
	(LIGHT_NOON_POS_Y - LIGHT_SUNRISE_POS_Y) / SUN_MOVING_TIME,
	(LIGHT_NOON_POS_Z - LIGHT_SUNRISE_POS_Z) / SUN_MOVING_TIME
);
XMFLOAT3 NoonToSet = XMFLOAT3((LIGHT_SUNSET_POS_X - LIGHT_NOON_POS_X) / SUN_MOVING_TIME,
	(LIGHT_SUNSET_POS_Y - LIGHT_NOON_POS_Y) / SUN_MOVING_TIME,
	(LIGHT_SUNSET_POS_Z - LIGHT_NOON_POS_Z) / SUN_MOVING_TIME
);
XMFLOAT3 SetToMidnight = XMFLOAT3((LIGHT_MIDNINGT_POS_X - LIGHT_SUNSET_POS_X) / SUN_MOVING_TIME,
	(LIGHT_MIDNINGT_POS_Y - LIGHT_SUNSET_POS_Y) / SUN_MOVING_TIME,
	(LIGHT_MIDNINGT_POS_Z - LIGHT_SUNSET_POS_Z) / SUN_MOVING_TIME
);
XMFLOAT3 MidnightToRise = XMFLOAT3((LIGHT_SUNRISE_POS_X - LIGHT_MIDNINGT_POS_X) / SUN_MOVING_TIME,
